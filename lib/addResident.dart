...
class _AddResidentPageState extends State<AddResidentPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final checkInController = TextEditingController();  // Add controllers for check-in and check-out dates
          ...
          GestureDetector(
                onTap: () async {
                  ...
                  if (selectedDate != null) {
                    ...
                    checkInController.text = "${selectedDate.toLocal()}".split(' ')[0];  // Update controller
                  }
                },
                child: AbsorbPointer(
                  child: TextField(
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  if (selectedDate != null) {
                    ...
                    checkOutController.text = "${selectedDate.toLocal()}".split(' ')[0];  // Update controller
                  }
                },
                child: AbsorbPointer(
                  child: TextField(
            ...
            ElevatedButton(
              onPressed: () {
                ...
                print("Resident added successfully with room details: $roomDetails");       
                if (roomDetails != null) {
                  ...
                  print("Failed to add resident. No suitable room available.");
                }
              }).catchError((error) {
                print("An error occurred while assigning a room: $error");
              });
              }
            },
