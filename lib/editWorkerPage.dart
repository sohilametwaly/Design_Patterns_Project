...
class _EditWorkerPageState extends State<EditWorkerPage> {
  ...
  void initState() {
    ...
    _salaryController = TextEditingController(text: widget.worker.salary.toString());
  }
      ...
      body: Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            ElevatedButton(
              onPressed: () {
                if (_nameController.text.isNotEmpty && _jobTitleController.text.isNotEmpty) {
                  ...
                  widget.worker.salary = double.tryParse(_salaryController.text) ?? 0.0;
