...
//   ResidentListScreen({required this.receptionist});
...
//     Map<String, Map<String, dynamic>> residentsData =
//         await widget.receptionist.viewResidents();
//     return residentsData.entries.map((entry) {
...
//             return Center(child: Text("Error loading residents"));
...
//                         context,
//                         MaterialPageRoute(
//                           builder: (_) => AddResidentPage(
//                             resident: {
//                               'name': resident.name,
//                               'id': resident.id,
//                               'email': resident.email,
//                               'roomType': room.roomType,
//                               'selectedRoom': resident.booking.room.roomNumber,
...
//                         setState(() {
//                           widget.receptionist.editResident(
...
//                                resident.booking, // Preserve the booking
//                             ),
//                           );
//                         });
//                       }
...
//                             residentId: resident.id.toString() ?? " ", // Replace with your target page
//                           ),
//                         ),
//                       );
//                     },
...
//         //       Booking booking = Booking(int.parse(uniqueId), duration, , option);

//         //       Resident newResident = Resident(
//         //           int.parse(uniqueId),
//         //           newResidentData['name'],
//         //           newResidentData['email'],
//         //           newResidentData['phone'],
//         //           booking,
//         //         );

//         //       widget.receptionist.addResident(newResident, newResidentData['roomType']); // Add new resident

//         //       // Room assignment logic
//         //       // RoomAssigner roomAssigner = RoomAssigner();
//         //       // roomAssigner.assignRoom(newResident, newResidentData['roomType']);
//         //     });
//         //   }
//          },
...
//           onPressed: () {
//             setState(() {
//               widget.receptionist.deleteResident(id);  // Delete resident
//             });
...
// class ResidentListScreen extends StatefulWidget {
//   final ResidentManagement management;
//   //final Map<String, dynamic> residentData;
//   ResidentListScreen({required this.management});
...
//   Future<List<Resident>> _fetchResidents() async {
//     final workerData = await widget.management.viewResidents();
